...
export const AGENTIC_V2_SCORES: AgenticV2Score[] = [
  ...
  { rank: '#4', modelSlug: 'gpt-oss-20b-medium',       name: 'GPT OSS 20B',      vendor: 'OpenAI',          phase1: 21,   phase1Max: 40, phase2:  null, total: 21,   totalMax: 40, phase2Qualified: false, verdict: 'Outdated tool knowledge — failed to build the baseline', tone: 'bad'  },
